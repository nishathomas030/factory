...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO drum_collection (date, barrels) VALUES ('$date', '$barrels')";
    if (mysqli_query($conn, $query)) {
        echo "<script>alert('Record added successfully!'); window.location.href='drum_view.php';</script>";
    } else {
